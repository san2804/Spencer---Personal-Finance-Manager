...
namespace PersonnelFinanceManager
{
    public partial class ExpenseForm : Form
    {
        ...
        private void LoadExpenseCategories()
        {
            try
            {
                ExpenseCategoryManager dbManager = new ExpenseCategoryManager();
                ...
                DataTable incomeCategoryData = dbManager.GetExpenseCategoriesByUser(loggedInUserId);
                ...
                {
                    MessageBox.Show("No expense categories found.", "Information", MessageBoxButtons.OK, MessageBoxIcon.Information);
                }
            }
            catch (Exception ex)
            {
        ...
        private void AddExpenseCategory()
        {
            try
            {
                ...
                string categoryName = expensecategory_txt.Text.Trim(); // Get the category name from the textbox
                ...
                ExpenseCategoryManager manager = new ExpenseCategoryManager();

                // Insert the category into the database
                bool result = manager.AddExpenseCategory(userId, categoryName);

                if (result)
                {
                    MessageBox.Show("Category added successfully.", "Success", MessageBoxButtons.OK, MessageBoxIcon.Information);
                    LoadExpenseCategories(); // Reload the income categories to refresh the data grid
                }
                else
                {
